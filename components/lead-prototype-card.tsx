          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Solicitar un prototipo consume creditos de tu saldo interno y deja la generacion real pendiente hasta conectar IA.
              </p>
            </div>
            {prototype ? (
              ...
              {prototype ? (
                <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    La generacion real y las iteraciones con `v0` quedaran conectadas en un slice posterior.
                  </p>
                ...
                <div className="rounded-lg border bg-muted/20 p-4 space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Esta accion descuenta creditos ahora y deja el prototipo en estado pendiente para que luego se conecte la generacion real.
                      </p>
                    </div>
                  </div>
      ...
      <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta accion consume {prototypeRequestCost ?? 0} creditos de tu saldo interno. La generacion real del prototipo quedara pendiente hasta conectar el modulo de IA.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
